              ...
              <SheetTrigger className="w-full bg-white border border-orange-100 rounded-xl p-4 shadow-sm flex items-center justify-between hover:shadow-md transition-shadow duration-200">
                <div className="flex items-center gap-3 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="font-semibold text-slate-800 text-sm truncate">تصفح الخطوات</div>
                    <div className="text-xs text-slate-500">اختر خطوة أخرى</div>
                  </div>
                </div>
          ...
          <div className="lg:col-span-8 col-span-full">
            <div className="rounded-xl shadow-lg border overflow-hidden bg-white border-orange-100">
              ...
              <div className="p-4 sm:p-6 lg:p-8 space-y-6 sm:space-y-8">
                ...
                <div className="space-y-4">
                  <h3 className="text-base sm:text-lg font-semibold text-slate-800 mb-4">مسارات النقل</h3>
                ...
                <div className="space-y-4">
                  <h3 className="text-base sm:text-lg font-semibold text-slate-800">فيديو تعليمي</h3>
